...
from svm_news_classifier import SVMTopicClassifier
from topic_modeling_prep import TopicModelingPrep

# MLflow tracking URI setup
TRACKING_URI = "http://localhost:8050"
EXPERIMENT_NAME = "svm_news-classification"
DATA_DIR = "~/data"  # EC2 data directory


def load_and_prepare_data():
    """Load and prepare the news dataset."""
    data_path = os.path.join(DATA_DIR, "processed_news_dataset_sample.csv")
